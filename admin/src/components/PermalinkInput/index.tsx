/**
 * @TODO - Migrate helper-plugin and pretty much EVERYTHING in this component.
 */
...
import { PLUGIN_ID, URI_COMPONENT_REGEX } from '../../constants';
...
const PermalinkInput = forwardRef((props, ref) => {
  ...
  const checkAvailability = async () => {
    ...
    try {
      ...
      const endpoint = getApiUrl(`${PLUGIN_ID}/check-availability/${params}`);
  ...
  const checkConnection = async () => {
    ...
    try {
      ...
      const endpoint = getApiUrl(`${PLUGIN_ID}/check-connection/${params}`);
  ...
  const updateAncestorsPath = async () => {
    ...
    try {
      ...
      const endpoint = getApiUrl(`${PLUGIN_ID}/ancestors-path/${params}`);
  ...
  generateUID.current = async (shouldSetInitialValue = false) => {
    ...
    try {
      ...
      const endpoint = getApiUrl(`${PLUGIN_ID}/suggestion/${params}`);
